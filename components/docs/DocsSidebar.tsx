...
export default function DocsSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 bottom-0 left-0 z-[160] w-72 bg-[#100e0b] border-r border-[var(--line)] flex flex-col transition-transform duration-300 ${
      ...
      >
        ...
        <div className="p-5 border-b border-[var(--line)] flex items-center justify-between">
          <a href="/" className="flex items-center gap-3">
            <Seal size={36} className="!text-sm">A</Seal>
            <div>
              <span className="font-display text-lg font-bold tracking-wider text-[var(--ink)] block leading-none">
                ACTA
              </span>
              <span className="caps text-[8.5px] text-[var(--gold)] tracking-widest block mt-0.5">
                Protocol Docs
              </span>
            </div>
          </a>
          {mobileOpen && (
            <button
              onClick={onCloseMobile}
              className="lg:hidden p-1.5 rounded-lg text-[var(--ink3)] hover:text-[var(--ink)] hover:bg-white/5"
            >
              <X size={18} />
            </button>
          )}
        ...
        <div className="p-3 border-b border-[var(--line)]/50">
          <button
        ...
        {/* Sidebar Footer */}
        <div className="p-4 border-t border-[var(--line)] bg-[#0d0b08] space-y-2">
