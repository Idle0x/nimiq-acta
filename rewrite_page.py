...
pattern = r'\{\/\* RADAR TAB \*\/\}\s*<div className="space-y-4">\s*<div className="flex items-center justify-between mb-4">.*?(?=\{\/\* ACTIVE ESCROWS TAB \*\/\})'

new_content = re.sub(pattern, '{/* RADAR TAB */}\n<div className="pb-10">\n' + new_radar + '\n</div>\n\n', content, flags=re.DOTALL)
