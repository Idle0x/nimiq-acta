...
This guide details the 60-second walkthrough featured in the [Acta Demo Video](https://youtu.be/eLxVdYTx0Lo).

---

## 60-Second Walkthrough Script

### Act I: Identity & The Vault (0:00 - 0:15)
...
### Act II: Escrowed Borrowing Flow (0:15 - 0:35)
...
### Act III: Multi-Oracle Bounties (0:35 - 0:50)
...
### Act IV: Reputation & Settlement Receipts (0:50 - 1:00)
