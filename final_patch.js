...
// 3. Radar Tab Replace (Dashboard + Profile Previews)
...
// 4. Stepper Progress bar (Active Tab)
// We look for: <p className="tnum mt-2 text-2xl font-extrabold"> and insert the stepper BEFORE it.
const replaceTarget = '<p className="tnum mt-2 text-2xl font-extrabold">';
const stepperHtml = `
...
content = content.replace(replaceTarget, stepperHtml);
