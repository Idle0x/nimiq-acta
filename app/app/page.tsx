        ...
        <main className="flex-1 overflow-y-auto px-4 pt-4 pb-6 no-scrollbar">
          ...
          {tab === "radar" && (
            <div className="pb-10 animate-fade-in">
              {dashboard && <TreasuryCard fees={dashboard.stats.treasury_fees} distributed={dashboard.stats.treasury_distributed} price={dashboard.price} balance={dashboard.vault?.balance_nim ?? null} vaultAddress={dashboard.vault?.address} />}
              {dashboard && (
