...
export async function GET(_req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  if (!sql) {
    ...
    return NextResponse.json({
      listing: {
        ...
        targetLat: listing.targetLat ?? null,
        targetLng: listing.targetLng ?? null,
  ...
  return NextResponse.json({
    listing: {
      ...
      durationDays: num(l, "duration_days", "durationDays") || 1,
      targetLat: l.target_lat != null ? Number(l.target_lat) : null,
      targetLng: l.target_lng != null ? Number(l.target_lng) : null,
